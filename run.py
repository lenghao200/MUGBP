...
def parse_arguments():
    ...
    parser.add_argument('--method', type=str, default='mugbp', help="which method to use.")
    ...
    parser.add_argument('--num_workers', type=int, default=0, help="The number of workers to load data.") # 原为8 2可以
    ...
    parser.add_argument('--cache_path', type=str, default='model/bert-large-uncased', help="The caching directory for pre-trained models.")   
    ...
    parser.add_argument("--config_file_name", type=str, default='MUGBP_MIntRec.py', help = "The name of the config file.")
...
if __name__ == '__main__':
    ...
    if not args.train and not os.path.exists(os.path.join(args.model_output_path, 'pytorch_model.bin')):
        print(f"Pre-trained model not found at {os.path.join(args.model_output_path, 'pytorch_model.bin')}. Switching to training mode.")
        args.train = True
